...
var AppComponent = /** @class */ (function () {
    function AppComponent(_commsService) {
    ...
    AppComponent.prototype.setActive = function (location_ind) {
...
var CommsService = /** @class */ (function () {
    function CommsService() {
    }
    CommsService.prototype.setLocationData = function (data) {
        this.currentLocations = data;
    };
    CommsService.prototype.getLocationData = function (zip) {
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.getWeather = function (zipcode) {
...
var WeatherComponent = /** @class */ (function () {
    function WeatherComponent(route, _httpService, _commsService) {
        this.route = route;
    ...
    WeatherComponent.prototype.getZipCode = function () {
        var _this = this;
        this.route.params.subscribe(function (zip) {
            var weatherData = _this._httpService.getWeather(zip.zip);
            weatherData.subscribe(function (data) {
                _this.weatherInfo = data;
                // console.log(data);
            });
            var data = _this._commsService.getLocationData(zip.zip);
            _this.image = data.img;
        });
    };
    WeatherComponent.prototype.getLocationName = function () {
        var _this = this;
        this.route.params.subscribe(function (location) {
            _this.locationName = location.location;
        });
    };
